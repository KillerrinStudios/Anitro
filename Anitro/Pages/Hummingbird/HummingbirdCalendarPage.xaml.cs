...
namespace Anitro.Pages.Hummingbird
{
    ...
    /// </summary>
    public sealed partial class HummingbirdCalendarPage : Page
    {
        public HummingbirdCalendarViewModel ViewModel { get { return (HummingbirdCalendarViewModel)DataContext; } }

        public HummingbirdCalendarPage()
        {
