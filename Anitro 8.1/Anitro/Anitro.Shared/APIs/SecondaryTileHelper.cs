...
#if WINDOWS_APP
        public static async Task<bool> CreateTile(object sender, string tileID, string textOnTile, AnitroLaunchArgs activationArguments, Uri _tileImage, TileSize tileSize)
#elif WINDOWS_PHONE_APP
        public static async Task<bool> CreateTile(string tileID, string textOnTile, AnitroLaunchArgs activationArguments, Uri _tileImage, TileSize tileSize)
#endif
        {
